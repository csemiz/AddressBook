...
namespace AddressBookPL.DefaultData
{
    public class DataDefaultXihan
    {
        ...
        public void CreateSomeNeighbourhood(INeighbourhoodManager neighbourhoodManager, ICityManager cityManager, IDistrictManager districtManager)
        {
            ...
            {
                //return; //NOT:
                //Bu metodu yazmak best practice degildir. 70bin datasi olan exceli projeyi yormamak icin insert into ile eklemek dahamantiklidir.!! Ya da Console Application ile excel i okuyup ekleyebiliriz.

                //Burada sadece birkac tane ilin datasini ekleyecegiz.
